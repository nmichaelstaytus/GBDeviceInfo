...
typedef NS_ENUM(NSInteger, GBDeviceModel) {
    ...
    GBDeviceModeliPhone16ProMax,
    GBDeviceModeliPhone16,
    GBDeviceModeliPhone16Plus,
    GBDeviceModeliPhone16e,
    GBDeviceModeliPhone17Pro,
    GBDeviceModeliPhone17ProMax,
    GBDeviceModeliPhone17,
    GBDeviceModeliPhoneAir,
    GBDeviceModeliPhone17e,
    GBDeviceModeliPhone18Pro,
    GBDeviceModeliPhone18ProMax,
    GBDeviceModeliPhoneDuo,
    GBDeviceModeliPad1,
    GBDeviceModeliPad2,
    GBDeviceModeliPad3,
    GBDeviceModeliPad4,
    ...
    GBDeviceModeliPadAir11InchM3,
    GBDeviceModeliPadAir13InchM3,
    GBDeviceModeliPadPro11Inch5,
    GBDeviceModeliPadPro12p9Inch7,
    GBDeviceModeliPadPro11Inch6,
    GBDeviceModeliPadPro13Inch8,
    GBDeviceModeliPadAir11InchM4,
    GBDeviceModeliPadAir13InchM4,
    GBDeviceModeliPod1,
    GBDeviceModeliPod2,
    GBDeviceModeliPod3,
    GBDeviceModeliPod4,
...
typedef NS_ENUM(NSInteger, GBDeviceDisplay) {
    ...
    GBDeviceDisplay6p3Inch,
    GBDeviceDisplay6p5Inch,
    GBDeviceDisplay6p6Inch,
    GBDeviceDisplay6p7Inch,
    GBDeviceDisplay6p9Inch,
